...
module.exports = {
    ...
    list: async (req, res) => {
        /*
            ...
            `
        */
    //    this is another way of adding some filters to get categories base on the "electronics"
            // const data = await res.getModelList(Product, { category: 'Electronics' }, ['category_id', 'brand_id'])
